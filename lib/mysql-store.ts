...
export async function addProperty(property: Property): Promise<void> {
  const data = {
    ...
    detailed_description: typeof (property as any).detailedDescription === 'string' ? (property as any).detailedDescription : JSON.stringify((property as any).detailedDescription || null),
    environment: typeof (property as any).environment === 'string' ? (property as any).environment : JSON.stringify((property as any).environment || null),
    rental_conditions: typeof (property as any).rentalConditions === 'string' ? (property as any).rentalConditions : JSON.stringify((property as any).rentalConditions || null),
    purchase_conditions: typeof (property as any).purchaseConditions === 'string' ? (property as any).purchaseConditions : JSON.stringify((property as any).purchaseConditions || null),
    fees: typeof (property as any).fees === 'string' ? (property as any).fees : JSON.stringify((property as any).fees || null),
    legal_info: typeof (property as any).legalInfo === 'string' ? (property as any).legalInfo : JSON.stringify((property as any).legalInfo || null),
    pricing_info: typeof (property as any).pricingInfo === 'string' ? (property as any).pricingInfo : JSON.stringify((property as any).pricingInfo || null),
