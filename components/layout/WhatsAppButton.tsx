...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Bouton principal */}
      <div className="relative bg-[#25D366] text-white w-16 h-16 rounded-full shadow-2xl flex items-center justify-center hover:bg-[#20BA5A] transition-all duration-300 hover:scale-110 cursor-pointer">
      ...
      <div className="absolute right-20 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <div className="bg-gray-900 text-white px-4 py-2 rounded-lg shadow-xl whitespace-nowrap">
          ...
          <p className="text-xs text-gray-300">Contactez-nous sur WhatsApp</p>
        </div>
        {/* Flèche */}
